...
Button PlayButton(START_BUTON_POSX, START_BUTTON_POSY);
Button HelpButton(HELP_BUTTON_POSX, HELP_BUTTON_POSY);
Button ExitButton(QUIT_BUTTON_POSX, QUIT_BUTTON_POSY);
...
bool LoadMedia()
{
	...
	else
	{
		...
		else
		{
			...
			if (!gPlayButtonTexture.LoadFromFile("imgs/button/big_button/start_button.png", gRenderer))
			{
				std::cout << "Failed to load start_button image" << std::endl;
				success = false;
			}
			else
			{
			...
			if (!gExitButtonTexture.LoadFromFile("imgs/button/big_button/quit_button.png", gRenderer))
			{
				std::cout << "Failed to load quit_button image" << std::endl;
				success = false;
			}
			else
			{
			...
			{
				gCharacterClips[0].x = 85 * 0;
				gCharacterClips[0].y = 0;
				gCharacterClips[0].w = 85;
				gCharacterClips[0].h = 85;

				gCharacterClips[1].x = 85 * 1;
				gCharacterClips[1].y = 0;
				gCharacterClips[1].w = 85;
				gCharacterClips[1].h = 85;

				gCharacterClips[2].x = 85 * 2;
				gCharacterClips[2].y = 0;
				gCharacterClips[2].w = 85;
				gCharacterClips[2].h = 85;

				gCharacterClips[3].x = 85 * 3;
				gCharacterClips[3].y = 0;
				gCharacterClips[3].w = 85;
				gCharacterClips[3].h = 85;

				gCharacterClips[4].x = 85 * 4;
				gCharacterClips[4].y = 0;
				gCharacterClips[4].w = 85;
				gCharacterClips[4].h = 85;

				gCharacterClips[5].x = 85 * 5;
				gCharacterClips[5].y = 0;
				gCharacterClips[5].w = 85;
