...
void GenerateEnemy(Enemy& enemy1,
	...
	SDL_Renderer * gRenderer)
{
	enemy1.LoadFromFile("imgs/enemy/stone.png", gRenderer);
	enemy2.LoadFromFile("imgs/enemy/stone.png", gRenderer);
	enemy3.LoadFromFile("imgs/enemy/eagle.png", gRenderer);
	{
